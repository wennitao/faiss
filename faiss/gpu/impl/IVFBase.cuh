...
class IVFBase {
   public:
    ...
    virtual void initTranslatedCodes(std::vector<uint8_t*>& translatedCodes);
    virtual void storeTranslatedCodes(const InvertedLists* ivf, std::vector<uint8_t*>& translatedCodes);
